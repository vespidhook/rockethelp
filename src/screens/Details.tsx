...
import { VStack, Text as NativeBaseText, HStack, useTheme, ScrollView as NativeBaseScrollView, Box } from 'native-base';
  ...
  return (
    <VStack flex={1} bg="gray.700">
      <Box px={6} bg="gray.600">
        ...
        <NativeBaseScrollView mx={5} showsVerticalScrollIndicator={false}>
          <CardDetails 
            title="equipamento"
          ...
          <CardDetails 
            ...
            icon={ClipboardText}
            footer={`Regitrado em ${order.when}`}
          />
